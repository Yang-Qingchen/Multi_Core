...
//		{			
//			if(Fifo_1.Val_1[Fifo_1.write_1] == 0)  // 表示数据已被读过
//			{
//				mtx_FIFO_1.lock();  // 上锁
...
//			else
//			{
//				while (Fifo_1.Val_1[Fifo_1.write_1] != 0)
//				{
//					if (Fifo_1.Val_1[Fifo_1.write_1] == 0)
//						break;
//				}
//				mtx_FIFO_1.lock();
//				Fifo_1.Val_1[Fifo_1.write_1] = val;
...
//		if ((Fifo_2.write_2 != (grenz - 1)))
//		{
//			if (Fifo_2.Val_2[Fifo_2.write_2] == 0)  // 表示数据已被读过
//			{
//				mtx_FIFO_2.lock();  // 上锁
//				Fifo_2.Val_2[Fifo_2.write_2] = val;
//				Fifo_2.nochfrei--;
...
//			else
//			{
//				while (Fifo_2.Val_2[Fifo_2.write_2] != 0)
//				{
//					if (Fifo_2.Val_2[Fifo_2.write_2] == 0)
//						break;
//				}
//				mtx_FIFO_2.lock();
//				Fifo_2.Val_2[Fifo_2.write_2] = val;
...
//		if ((Fifo_3.write_3 != (grenz - 1)))
//		{
//			if (Fifo_3.Val_3[Fifo_3.write_3] == 0)  // 表示数据已被读过
//			{
//				mtx_FIFO_3.lock();  // 上锁
//				Fifo_3.Val_3[Fifo_3.write_3] = val;
//				Fifo_3.nochfrei--;
...
//			else
//			{
//				while (Fifo_3.Val_3[Fifo_3.write_3] != 0)
//				{
//					if (Fifo_3.Val_3[Fifo_3.write_3] == 0)
//						break;
//				}
//				mtx_FIFO_3.lock();
//				Fifo_3.Val_3[Fifo_3.write_3] = val;
...
//		printf("读出的值是%f,", Val_From_FIFO_3 - 1);
